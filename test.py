...
class Predictor():
    def __init__(self, currency, training_days, test_days, changepoint_prior_scale=0.05):
    ...
    def make_model(self):
        ...
        # print(forecast['ds'], self.test['ds'])
    ...
    def predict(self, days, make_plot=True):
        ...
        # Init predictor object for bitcoin with 800 training days and 1 test day. 
# This around the time when BTC began showing its infamous volatility levels.
bitcoin_predictor = Predictor("bitcoin", 300, 1, 0.002)
